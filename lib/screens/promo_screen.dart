...
class PromoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final promos = [
      _Promo(
        'Diskon 20% Gunting + Cuci',
        'Berlaku s.d 30 Sept 2026',
        '20%',
        AppColors.rose,
      ),
      _Promo(
        'Bundling Creambath + Catok',
        'Hemat Rp 20.000',
        'Rp 80rb',
        AppColors.gold,
      ),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const _PackageCard(
            title: 'Paket Gunting + Cuci',
            subtitle: 'Pria atau Wanita dewasa',
            price: 'Rp 30.000',
          ),
          const _PackageCard(
            title: 'Paket Catok + Cuci',
            subtitle: 'Termasuk blow',
            price: 'Rp 40.000',
          ),
          const _PackageCard(
            title: 'Paket Creambath + Catok',
            subtitle: 'Perawatan lengkap',
            price: 'Rp 90.000',
          ),
        ],
      ),
